...
<div style="font-family: Arial, sans-serif; background-color: #f9f9f9; padding: 20px;">
  <div style=" max-width: 600px; margin: auto; background-color: #ffffff; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
    ...
    <p style="padding: 1.5rem 0"><a href="${url}/auth/reset-password?token=${resetToken}" style="background-color: #e74c3c; color: #ffffff; padding: 15px; text-decoration: none; border-radius: 5px;">🔐 Réinitialiser votre mot de passe 🔐</a ></p>
    <p style="color: #555555">Le bouton ne fonctionne pas?<br />Utiliser ce lien <a href="${url}/auth/reset-password?token=${resetToken}" style="color: #e74c3c; text-decoration: none">${url}/auth/reset-password?token=${resetToken}</a ></p>
